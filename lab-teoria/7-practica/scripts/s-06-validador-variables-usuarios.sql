...
define p7_previo_usr=nimo_p07_previo
--password del usuario del previo
define p7_previo_usr_pwd=nestor

--username del usuario admin
define p7_usr_admin=nimo_p0701_admin
--password del usuario admin
define p7_usr_admin_pwd=admin

--username del usuario admin
define p7_usr_oper=nimo_p0701_oper
--password del usuario admin
define p7_usr_oper_pwd=oper

--username del usuario invitado
define p7_usr_invitado=nimo_p0701_invitado
